import{w as g,O as s,x as c}from"./react-vendor-Angmm_rT.js";import{n as w,Y as d,t as r}from"./lit-element-Ct-YVhn4.js";var u=Object.defineProperty,A=Object.getOwnPropertyDescriptor,o=(a,l,i,h)=>{for(var e=h>1?void 0:h?A(l,i):l,p=a.length-1,n;p>=0;p--)(n=a[p])&&(e=(h?n(l,i,e):n(e))||e);return h&&e&&u(l,i,e),e};let t=class extends w{constructor(){super(...arguments),this.size="1em",this.weight="regular",this.color="currentColor",this.mirrored=!1}render(){var a;return d`<svg
  ...
  `;o([s({type:String,reflect:!0})],t.prototype,"size",2);o([s({type:String,reflect:!0})],t.prototype,"weight",2);o([s({type:String,reflect:!0})],t.prototype,"color",2);o([s({type:Boolean,reflect:!0})],t.prototype,"mirrored",2);t=o([c("ph-arrow-clockwise")],t);export{t as PhArrowClockwise};
