import{w as l,O as p,x as n}from"./react-vendor-Angmm_rT.js";import{n as g,Y as c,t as r}from"./lit-element-Ct-YVhn4.js";var d=Object.defineProperty,Z=Object.getOwnPropertyDescriptor,a=(o,s,H,i)=>{for(var e=i>1?void 0:i?Z(s,H):s,V=o.length-1,h;V>=0;V--)(h=o[V])&&(e=(i?h(s,H,e):h(e))||e);return i&&e&&d(s,H,e),e};let t=class extends g{constructor(){super(...arguments),this.size="1em",this.weight="regular",this.color="currentColor",this.mirrored=!1}render(){var o;return c`<svg
  ...
  `;a([p({type:String,reflect:!0})],t.prototype,"size",2);a([p({type:String,reflect:!0})],t.prototype,"weight",2);a([p({type:String,reflect:!0})],t.prototype,"color",2);a([p({type:Boolean,reflect:!0})],t.prototype,"mirrored",2);t=a([n("ph-browser")],t);export{t as PhBrowser};
