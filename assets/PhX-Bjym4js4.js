import{w as L,O as l,x as g}from"./react-vendor-Angmm_rT.js";import{n as d,Y as c,t as r}from"./lit-element-Ct-YVhn4.js";var u=Object.defineProperty,w=Object.getOwnPropertyDescriptor,o=(a,s,p,i)=>{for(var e=i>1?void 0:i?w(s,p):s,h=a.length-1,n;h>=0;h--)(n=a[h])&&(e=(i?n(s,p,e):n(e))||e);return i&&e&&u(s,p,e),e};let t=class extends d{constructor(){super(...arguments),this.size="1em",this.weight="regular",this.color="currentColor",this.mirrored=!1}render(){var a;return c`<svg
  ...
  `;o([l({type:String,reflect:!0})],t.prototype,"size",2);o([l({type:String,reflect:!0})],t.prototype,"weight",2);o([l({type:String,reflect:!0})],t.prototype,"color",2);o([l({type:Boolean,reflect:!0})],t.prototype,"mirrored",2);t=o([g("ph-x")],t);export{t as PhX};
